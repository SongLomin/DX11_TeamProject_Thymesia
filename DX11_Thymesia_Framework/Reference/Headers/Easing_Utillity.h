...
//public:
//	_vector	Easing(_uint eEasingType, _vector vStartPoint, _vector vTargetPoint, _float fPassedTime, _float fTotalTime);


public:
	static _vector LerpToType(_vector vStartPoint, _vector vTargetPoint, _float fPassedTime, _float fTotalTime,
		EASING_TYPE eType);
