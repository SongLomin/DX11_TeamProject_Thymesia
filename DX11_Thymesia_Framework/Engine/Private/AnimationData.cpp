...
#define MACRO(AnimationName, WantedSpeed)\
    ...
    MACRO("Corvus_Raven_ClawLong_ChargeFull", 2.625f);
    ...
    MACRO("Corvus_SD_ParryDeflect_L", 2.f);
    MACRO("Corvus_SD_ParryDeflect_LUp", 2.f);

	MACRO("Corvus_SD_ParryDeflect_R", 2.f);
	MACRO("Corvus_SD_ParryDeflect_RUp", 2.f);

	MACRO("Corvus_SD_Ladder_Climb_L_UP", 2.f);
	MACRO("Corvus_SD_Ladder_Climb_R_UP", 2.f);
	MACRO("Corvus_SD_Ladder_Climb_L_Down", 2.f);
	MACRO("Corvus_SD_Ladder_Climb_R_Down", 2.f);
