...
void CCorvusState_Climb_L_UP::Start()
{
	...
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("SK_C_Corvus.ao|Corvus_SD_Ladder_Climb_L_UP");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_Climb_L_UP::Call_AnimationEnd, this);
}
...
void CCorvusState_Climb_L_UP::Call_AnimationEnd()
{
	if (!Get_Enable())
		return;
...
void CCorvusState_Climb_L_UP::Call_NextKeyFrame(const _uint& In_KeyIndex)
{
	...
	_vector fOffSet = { 0.f, 0.000976190476f ,0.f };
