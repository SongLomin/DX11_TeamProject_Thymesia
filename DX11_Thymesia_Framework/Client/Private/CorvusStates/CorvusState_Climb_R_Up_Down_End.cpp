...
void CCorvusState_Climb_R_Up_Down_End::Start()
{
	...
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_Climb_R_Up_Down_End::Call_AnimationEnd, this);
}
...
void CCorvusState_Climb_R_Up_Down_End::Call_AnimationEnd()
{
	if (!Get_Enable())
		return;
