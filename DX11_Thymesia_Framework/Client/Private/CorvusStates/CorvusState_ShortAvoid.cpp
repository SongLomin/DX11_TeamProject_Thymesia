...
void CCorvusState_ShortAvoid::Start()
{
	...
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("SK_C_Corvus.ao|Corvus_SD_AvoidShort_F");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_ShortAvoid::Call_AnimationEnd, this);
}
