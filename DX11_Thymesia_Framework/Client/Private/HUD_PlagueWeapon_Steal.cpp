...
void CHUD_PlagueWeapon_Steal::Tick(_float fTimeDelta)
{
    ...
    if (m_bIsCoolTime)
    {
        ...
        if (m_fCoolTime <= m_fNowTime)//쿨타임이 다 찼을 시.
        {
            ...
            m_pHover.lock()->CallBack_FadeEnd -= bind(&CHUD_PlagueWeapon_Steal::Call_HoverFadeEnd, this, placeholders::_1);
...
void CHUD_PlagueWeapon_Steal::Call_HoverFadeEnd(FADER_TYPE eFaderType)
{
