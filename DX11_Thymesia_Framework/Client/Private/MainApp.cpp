...
HRESULT CMainApp::Initialize()
{
	...
	GAMEINSTANCE->Check_Group((_uint)COLLISION_LAYER::PLAYER_RIGIDBODY, (_uint)COLLISION_LAYER::MONSTER_RIGIDBODY);
	GAMEINSTANCE->Check_Group((_uint)COLLISION_LAYER::MONSTER_RIGIDBODY, (_uint)COLLISION_LAYER::MONSTER_RIGIDBODY);
