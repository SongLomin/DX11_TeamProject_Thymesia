...
GAMECLASS_C(CEditMapTool)
CLONE_C(CEditMapTool, CGameObject)

#define D3DCOLOR_ABGR(a,r,g,b) \
    ((D3DCOLOR)((((a)&0xff)<<24)|(((r)&0xff)<<16)|(((g)&0xff)<<8)|((b)&0xff)))

HRESULT CEditMapTool::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CEditMapTool::Initialize(void* pArg)
{
...
HRESULT CEditMapTool::Start()
{
	return S_OK;
}

void CEditMapTool::Tick(_float fTimeDelta)
{
	if (!m_bCreate)
		return;
...
void CEditMapTool::LateTick(_float fTimeDelta)
{
	if (!m_bCreate)
		return;
...
HRESULT CEditMapTool::SetUp_ShaderResource()
{
...
void CEditMapTool::SetUp_EditMode()
{
	const char* items[] =
	{
		"HEIGHT_FLAT",
...
void CEditMapTool::SetUp_TextureComponent()
{

}

void CEditMapTool::SetUp_ShaderComponent()
{
...
void CEditMapTool::SetUp_PinckingInfo()
{
...
void CEditMapTool::SetUp_FillterInfo()
{
}

void CEditMapTool::PickingFillterTextureDraw()
{
...
void CEditMapTool::CreateBuffer()
{
...
void CEditMapTool::CreateFilterTexture()
{
	D3D11_TEXTURE2D_DESC	TextureDesc;
	ZeroMemory(&TextureDesc, sizeof(D3D11_TEXTURE2D_DESC));

	/*
	TextureDesc.Width				= m_vBufferInfo.x;
	TextureDesc.Height				= m_vBufferInfo.y;
	*/
...
void CEditMapTool::PickingGround()
{
	RAY MouseRayInWorldSpace = SMath::Get_MouseRayInWorldSpace(g_iWinCX, g_iWinCY);
...
void CEditMapTool::Bake_FilterTexture()
{
...
void CEditMapTool::Load_AllMeshInfo()
{
...
void CEditMapTool::OnEventMessage(_uint iArg)
{
