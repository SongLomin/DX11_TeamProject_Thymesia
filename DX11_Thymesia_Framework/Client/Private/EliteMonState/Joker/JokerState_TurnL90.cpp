...
void CJokerState_TurnL90::Start()
{
	...
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CJokerState_TurnL90::Call_AnimationEnd, this);
}
...
void CJokerState_TurnL90::LateTick(_float fTimeDelta)
{
	...
	m_pTransformCom.lock()->Turn(XMVectorSet(0.f, 1.f, 0.f, 0.f), fTimeDelta * fTurnValue * -1.f);
...
void CJokerState_TurnL90::Call_AnimationEnd()
{
	if (!Get_Enable())
		return;
