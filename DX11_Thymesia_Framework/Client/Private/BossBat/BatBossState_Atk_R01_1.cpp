...
void CBatBossState_Atk_R01_1::Start()
{
	...
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CBatBossState_Atk_R01_1::Call_AnimationEnd, this);
}
...
void CBatBossState_Atk_R01_1::Call_AnimationEnd()
{
	if (!Get_Enable())
		return;
...
void CBatBossState_Atk_R01_1::OnDestroy()
{
	m_pModelCom.lock()->CallBack_AnimationEnd -= bind(&CBatBossState_Atk_R01_1::Call_AnimationEnd, this);
}
