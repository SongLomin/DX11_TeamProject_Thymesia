...
void CVargBossState_Start::Start()
{
	...
	case Client::BOSSSTARTTYPE::BEGINSTART:
		m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Varg_Seq_TutorialBossFightStart");
		break;
	case Client::BOSSSTARTTYPE::NORMALSTART:
		m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Varg_Seq_BossFightStart");
		break;
	}
