...
void CVarg::Init_Desc()
{
	...
	m_pWeapons.back().lock()->Add_Collider({ 0.f,0.4f,-1.4f,1.0f }, 0.6f, COLLISION_LAYER::MONSTER_ATTACK);
	...
	m_pWeapons.back().lock()->Add_Collider({ 0.f,0.0f,-0.4f,1.0f }, 0.6f, COLLISION_LAYER::MONSTER_ATTACK);
