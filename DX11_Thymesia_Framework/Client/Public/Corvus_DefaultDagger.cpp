...
void CCorvus_DefaultDagger::Init_DefaultDagger(weak_ptr<CModel> In_pModelCom, weak_ptr<CGameObject> In_pParent, const string& szTargetNode)
{
...
void CCorvus_DefaultDagger::Enable_DefaultDagger(const HIT_TYPE& In_eHitType, const _float& In_fDamage)
{
...
void CCorvus_DefaultDagger::Disable_DefaultDagger()
{
...
void CCorvus_DefaultDagger::Set_DefaultDaggerScale(const _float& In_fWeaponScale)
{
...
void CCorvus_DefaultDagger::Set_OriginalDefaultDaggerScale()
{
	Set_DefaultDaggerScale(m_fOriginalWeaponScale);
}

weak_ptr<CGameObject> CCorvus_DefaultDagger::Get_ParentObject()
{
	return m_pParent;
}

void CCorvus_DefaultDagger::Set_DefaultSaberDesc(const _float& In_fWeaponScale, const _float3& In_vOffset, const HIT_TYPE& In_eHitType, const _float& In_fDamage)
{
	m_fWeaponScale = In_fWeaponScale;
	m_pHitColliderCom.lock()->Set_ColliderScale(XMVectorSet(In_fWeaponScale, In_fWeaponScale, In_fWeaponScale, 0.f));
