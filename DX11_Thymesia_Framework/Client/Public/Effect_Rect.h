...
#pragma region Scale
	void Update_ParticleScale_ApplyScaleSpeed(const _uint& i, _float fTimeDelta);
	void Update_ParticleScale_ApplyScaleForce(const _uint& i, _float fTimeDelta);
	void Update_ParticleScale_ApplyScaleSpeedAndForce(const _uint& i, _float fTimeDelta);
	void Update_ParticleScale_ApplySquareScale(const _uint& i, _float fTimeDelta);
	void Update_ParticleScale_ApplyRatioScale(const _uint& i, _float fTimeDelta);
	void Update_ParticleScale_ApplyCustomScale(const _uint& i, _float fTimeDelta);
